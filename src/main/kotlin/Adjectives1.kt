...
object Adjectives1 {
    ...
    fun callAdjective1(chatId: Long, bot: Bot) {
        println("callAdjective1: Выбран блок прилагательных 1")
    ...
    fun callChangeWordsAdjective1(chatId: Long, bot: Bot) {
        println("callChangeWordsAdjective1: Обработка изменения набора слов для прилагательных 1")
    ...
    fun handleBlockAdjective1(chatId: Long, bot: Bot) {
        ...
        if (Globals.userReplacements[chatId].isNullOrEmpty()) {
            ...
            println("U3 Сгенерированы замены: ${Globals.userReplacements[chatId]}")
        }
        ...
        println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  ${Globals.userStates[chatId]}")
